        ...
        <div className="grid gap-10 lg:grid-cols-[1fr_320px] lg:items-start">
          ...
          <aside className="border-l border-border pl-5 dark:border-border-dark" aria-label="Resumen del portafolio">
            ...
            <dl className="mt-6 grid gap-3">
              ...
              <a className="inline-flex items-center gap-2 border border-border px-5 py-3 text-sm font-semibold text-text-primary transition-transform hover:-translate-y-0.5 hover:border-accent dark:border-border-dark dark:text-text-primary-dark" href={content.site.cvPdfPath} target="_blank" rel="noreferrer">
                <Download size={18} />
